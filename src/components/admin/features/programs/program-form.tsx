...
export default function ProgramFormPage({ program }: ProgramFormPageProperties) {
  ...
  const SectionHeader = ({ title, description }: { title: string; description?: string }) => (
    <div>
      ...
      {description ? <p className="text-sm text-gray-500">{description}</p> : undefined}
    </div>
  );
    ...
    <div>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-5 rounded-md border border-gray-200 p-6">
          <SectionHeader
            title="Basic Details"
            description="Set up the essentials for this program: upload a clear thumbnail, add a concise title and description, define the duration and unit, and set a price. Keep it straightforward so admins can scan and understand the program at a glance."
          />
          ...
          <Collapsible defaultOpen>
            <div className="overflow-hidden rounded-md border border-gray-200">
              <div className="flex items-center justify-between bg-gray-50 px-4 py-3">
                <SectionHeader
                  title="Ideals"
                  description="Describe the audience this program is best suited for (e.g., beginners, busy professionals, postpartum mothers). Keep each item short and specific."
                />
                <div className="flex items-center gap-2">
                  ...
                  <CollapsibleTrigger asChild>
                    <Button
                      ...
                      className="transition data-[state=open]:[&_svg]:rotate-180"
                    >
          ...
          <Collapsible defaultOpen>
            <div className="overflow-hidden rounded-md border border-gray-200">
              <div className="flex items-center justify-between bg-gray-50 px-4 py-3">
                <SectionHeader
                  title="Key Features"
                  description="List the standout elements that make this program valuable (e.g., personalized plans, weekly check-ins, video lessons). Use short, punchy statements."
                />
                <div className="flex items-center gap-2">
                  <Button
                    type="button"
            ...
            <div className="overflow-hidden rounded-md border border-gray-200">
              <div className="flex items-center justify-between bg-gray-50 px-4 py-3">
                <SectionHeader
                  ...
                  description="Set clear, realistic results participants should expect after completing the program (e.g., lose 3–5kg, improve energy, build consistent habits)."
                />
                <div className="flex items-center gap-2">
                  <Button
                    type="button"
                ...
                {(form.data.expected_outcomes as ExpectedOutcomeInput[]).map((item, index) => (
                  <div key={`outcome-${index}`} className="flex items-end gap-3">
                    ...
                    <Button
                      ...
                      disabled={(form.data.expected_outcomes as ExpectedOutcomeInput[]).length <= 1}
                      className="hover:bg-destructive/10 hover:text-destructive self-end"
          ...
          <Collapsible defaultOpen>
            <div className="overflow-hidden rounded-md border border-gray-200">
              <div className="flex items-center justify-between bg-gray-50 px-4 py-3">
                <SectionHeader
                  title="Structures"
                  description="Break the program into weekly blocks. Give each week a short title and optionally add a brief description of focus or activities."
                />
                <div className="flex items-center gap-2">
                  <Button
                    type="button"
          ...
          <Collapsible defaultOpen>
            <div className="overflow-hidden rounded-md border border-gray-200">
              <div className="flex items-center justify-between bg-gray-50 px-4 py-3">
                <SectionHeader
                  title="FAQs"
                  description="Capture common questions admins or clients may have and provide clear, helpful answers to reduce back-and-forth."
                />
                <div className="flex items-center gap-2">
                  <Button
                    type="button"
