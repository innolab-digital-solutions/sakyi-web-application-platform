...
// Dummy program data - in real app, this would come from API/database
const programData = {
  "body-recomposition": {
...
interface ProgramDetailPageProperties {
  params: {
    slug: string;
  };
}
...
export async function generateMetadata({ params }: ProgramDetailPageProperties): Promise<Metadata> {
  const program = programData[params.slug as keyof typeof programData];

  if (!program) {
    return {
      title: "Program Not Found | SaKyi Health & Wellness",
      description: "The requested wellness program could not be found.",
    };
  }

  const title = `${program.title} | SaKyi Wellness Programs`;
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://sakyihealthandwellness.com/programs/${params.slug}`,
...
export default function ProgramDetailPage({ params }: ProgramDetailPageProperties) {
  const program = programData[params.slug as keyof typeof programData];
    ...
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-center">
          <h1 className="mb-4 text-4xl font-bold text-slate-900">Program Not Found</h1>
          <p className="mb-8 text-lg text-slate-600">
            The requested wellness program could not be found.
          </p>
          <Link
            href="/programs"
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-r from-[#35bec5]/10 to-[#0c96c4]/10">
                    <Clock className="h-6 w-6 text-[#35bec5]" />
                  </div>
                  <div>
                    <div
                ...
                <div className="flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-r from-[#35bec5]/10 to-[#0c96c4]/10">
                    <Users className="h-6 w-6 text-[#35bec5]" />
                  </div>
                  <div>
                    <div
                      className="text-sm text-slate-600"
                ...
                <div className="flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-r from-[#35bec5]/10 to-[#0c96c4]/10">
                    <Star className="h-6 w-6 text-[#35bec5]" />
                  </div>
                  <div>
                    <div
                      className="text-sm text-slate-600"
                ...
                <div className="flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-r from-[#35bec5]/10 to-[#0c96c4]/10">
                    <Heart className="h-6 w-6 text-[#35bec5]" />
                  </div>
                  <div>
                    <div
                      className="text-sm text-slate-600"
              ...
              >
                <Link
                  href="/contact"
                  className="group bg-brand-gradient inline-flex items-center justify-center gap-2 rounded-full px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
                  style={{ fontFamily: "Inter, sans-serif" }}
                >
                  <Heart className="h-5 w-5" />
                  Start This Program
                ...
                <Link
                  href="/programs"
                  className="group inline-flex items-center justify-center gap-2 rounded-full border-2 border-slate-300 bg-white px-8 py-4 text-lg font-semibold text-slate-700 shadow-sm transition-all duration-300 hover:scale-105 hover:border-[#35bec5] hover:bg-slate-50"
                  style={{ fontFamily: "Inter, sans-serif" }}
                >
                ...
                <ul className="space-y-3">
                  {program.idealFor.map((item, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <CheckCircle className="mt-1 h-5 w-5 flex-shrink-0 text-[#35bec5]" />
            ...
            >
              ...
              <div className="grid gap-4">
                {program.keyFeatures.map((feature, index) => (
                  <div
                    key={index}
                    className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-300 hover:border-[#35bec5]/50 hover:shadow-lg"
                    data-aos="slide-up"
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-r from-[#35bec5]/10 to-[#0c96c4]/10 transition-all duration-300 group-hover:scale-105">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p
              ...
              data-aos-easing="ease-out-cubic"
            >
              Transform your body and health with measurable, science-based results
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {program.expectedOutcomes.map((outcome, index) => (
              <div
                key={index}
                className="group rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm transition-all duration-300 hover:border-[#35bec5]/50 hover:shadow-lg"
                data-aos="flip-up"
              ...
              >
                <div className="mb-4 flex justify-center">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-[#35bec5]/10 to-[#0c96c4]/10 transition-all duration-300 group-hover:scale-105">
                    <CheckCircle className="h-8 w-8 text-[#35bec5]" />
                  </div>
                </div>
                <p
                  className="font-medium text-slate-900"
